...
This simplified syntax pulls from master every 1 hour and only works for public repositories.
 ...
 *  **INTERVAl** is the number of seconds between pulls; default is 1 hour, minimum 5. An
...
example.org {
    root /tmp/zones
    git https://github.com/coredns/release
}
~~~

Note: `coredns/release` does not contain any DNS data.
...
example.org {
    root /tmp/zones
    git https://github.com/coredns/release subdir
}
~~~
